...
@Component({
  selector: 'app-upsert-pregunta-voto',
  templateUrl: './upsert-pregunta-voto.component.html',
  styleUrls: ['./upsert-pregunta-voto.component.css'],
})
export class UpsertPreguntaVotoComponent implements OnInit, AfterViewInit {
