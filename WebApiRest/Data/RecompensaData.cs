...
namespace WebApiRest.Data
{
    public class RecompensaData
    {
        ...
        public async Task<RecompensaList> GetRecompensaList(string buscar, string idCategoria)
        {
            RecompensaList list = new()
            {
                Lista = new()
            ...
            cmd.Parameters.AddWithValue("@idCategoria", WC.GetTrim(idCategoria));
        ...
        public async Task<Usuario_RecompensalList> GetUsuarioRecompensaList(Guid idUsuario)
        {
            Usuario_RecompensalList list = new()
            {
                Lista = new()
            ...
            SqlCommand cmd = new("sp_B_Usuario_RecompensaByIdUsuario", sqlConnection)
            {
                CommandType = CommandType.StoredProcedure
            };
        ...
        public async Task<Response> CreateRecompensa(Recompensa recompensa)
        {
            ...
            cmd.Parameters.AddWithValue("@idCategoria", recompensa.IdCategoria);
        ...
        public async Task<Response> UpdateRecompensaByEstado(Recompensa recompensa)
        {
            Response response = new();

            SqlConnection sqlConnection = new(conexion.GetConnectionSqlServer());
            SqlCommand cmd = new("sp_U_RecompensaByEstado", sqlConnection)
            {
                CommandType = CommandType.StoredProcedure
            };

            cmd.Parameters.AddWithValue("@idRecompensa", recompensa.IdRecompensa);
            cmd.Parameters.AddWithValue("@estado", recompensa.Estado);
