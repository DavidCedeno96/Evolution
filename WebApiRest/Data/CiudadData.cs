...
namespace WebApiRest.Data
{
    public class CiudadData
    {
        ...
        public async Task<CiudadItem> GetCiudad(int estado, Guid idCiudad)
        {
            CiudadItem item = new();

            SqlConnection sqlConnection = new(conexion.GetConnectionSqlServer());

            SqlCommand cmd = new("sp_B_CiudadById", sqlConnection)
            {
                CommandType = CommandType.StoredProcedure
            };
        ...
        public async Task<CiudadItem> GetCiudad(string nombre)
        {
            CiudadItem item = new();

            SqlConnection sqlConnection = new(conexion.GetConnectionSqlServer());

            SqlCommand cmd = new("sp_B_CiudadByNombre", sqlConnection)
            {
                CommandType = CommandType.StoredProcedure
            };
